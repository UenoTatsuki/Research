...
#define START_OF_TRIGER1 4020
#define END_OF_TRIGER1 4070
#define START_OF_TRIGER4 4070
#define END_OF_TRIGER4 4075
#define START_OF_TRIGER5 4090
#define END_OF_TRIGER5 4095
#define NUM_PULSE 1
...
int main(){
	...
	while(t <= START_OF_TRIGER + 500){
        ...
        //Vnの出力
        printf("%f %f %f %f %f %f %f %f %f %f %f %f %f %f\n",t, Vns[0], Vns[1], Vns[2], Vns[3], Vns[4], Vns[5], Vns[6], Vns[7], Vnn[40][50], Vnn[50][42], Vnn[50][58], Vnn[51][57], Vnn[49][59]);
