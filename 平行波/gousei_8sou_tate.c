...
#define START_OF_TRIGER4 2540
#define END_OF_TRIGER4 2545
#define NUM_PULSE 1
	...
	while(t <= START_OF_TRIGER + 500){
        ...
        for(b = 1; b < NUMBER_OF_SINDOUSI_TATE-1; b++){
            for(a = 1; a < NUMBER_OF_SINDOUSI_YOKO-1; a++){
                ...
                V81[b][a] = Vnn[2*b][2*a];
                V41[b][a] = Vn4[b][a];
                if((b == 13 && a == 8) || (b == 13 && a == 11) || (b == 11 && a == 13) || (b == 8 && a == 13)){
                    Vst[b][a] = Vns;
                }else{
                    Vst[b][a] = 0;
                }
        ...
        for(b = 2; b < N_TATE-1; b++){
            for(a = 2; a < N_YOKO-1; a++){
                ...
                if((b == 26 && a == 22) || (b == 25 && a == 21) || (b == 25 && a == 23) || (b == 27 && a == 21) || (b == 22 && a == 26) || (b == 21 && a == 25) || (b == 21 && a == 27) || (b == 23 && a == 25)){
                    Vsn[b][a] = Vns;
                }else{
                    Vsn[b][a] = 0;
                }
