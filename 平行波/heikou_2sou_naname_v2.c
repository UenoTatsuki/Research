...
#define Trigger_Timing_3 1507.0 //2層目でトリガを印加するタイミング
...
int main() {
    ...
    double C1 = 0.5;//[aF]
    double C2 = 2.0;//[aF]
    double Vd8 = 0.00235;//[V]
    double Vd4 = 0.00365;//[V]
    double Vd1 = 0.00635;//[V]
    double Vin = 0.01;//[V]
    ...
    while (t <= T_END) {
        ...
        for (y = 2; y < HOW_MANY_SINDOU_tate8 - 2; y++) {
            for (x = 2; x < HOW_MANY_SINDOU_yoko8 - 2; x++) {
                if (y % 2 == 0 && x % 2 == 0){
                    q1 = (C8*(-dtQ8[y][x] + Cj * dtVn8[y][x - 2] + C8 * (7 * dtVn8[y][x - 2] - dtVn8[y][x + 2] - dtVn8[y - 2][x] - dtVn8[y + 2][x] - dtVn8[y - 1][x - 1] - dtVn8[y - 1][x + 1] - dtVn8[y + 1][x - 1] - dtVn8[y + 1][x + 1]) + C1 * (2 * dtVn8[y][x - 2] - dtVn1[y / 2][x / 2] - dtVn2[y / 2][x / 2]))) / (8 * C8 + 2 * C1 + Cj);
                    q2 = (C8*(-dtQ8[y][x] + Cj * dtVn8[y][x + 2] + C8 * (-dtVn8[y][x - 2] + 7 * dtVn8[y][x + 2] - dtVn8[y - 2][x] - dtVn8[y + 2][x] - dtVn8[y - 1][x - 1] - dtVn8[y - 1][x + 1] - dtVn8[y + 1][x - 1] - dtVn8[y + 1][x + 1]) + C1 * (2 * dtVn8[y][x + 2] - dtVn1[y / 2][x / 2] - dtVn2[y / 2][x / 2]))) / (8 * C8 + 2 * C1 + Cj);
                    q3 = (C8*(-dtQ8[y][x] + Cj * dtVn8[y - 2][x] + C8 * (-dtVn8[y][x - 2] - dtVn8[y][x + 2] + 7 * dtVn8[y - 2][x] - dtVn8[y + 2][x] - dtVn8[y - 1][x - 1] - dtVn8[y - 1][x + 1] - dtVn8[y + 1][x - 1] - dtVn8[y + 1][x + 1]) + C1 * (2 * dtVn8[y - 2][x] - dtVn1[y / 2][x / 2] - dtVn2[y / 2][x / 2]))) / (8 * C8 + 2 * C1 + Cj);
                    q4 = (C8*(-dtQ8[y][x] + Cj * dtVn8[y + 2][x] + C8 * (-dtVn8[y][x - 2] - dtVn8[y][x + 2] - dtVn8[y - 2][x] - 7 * dtVn8[y + 2][x] - dtVn8[y - 1][x - 1] - dtVn8[y - 1][x + 1] - dtVn8[y + 1][x - 1] - dtVn8[y + 1][x + 1]) + C1 * (2 * dtVn8[y + 2][x] - dtVn1[y / 2][x / 2] - dtVn2[y / 2][x / 2]))) / (8 * C8 + 2 * C1 + Cj);
                    q5 = (C8*(-dtQ8[y][x] + Cj * dtVn8[y - 1][x - 1] + C8 * (-dtVn8[y][x - 2] - dtVn8[y][x + 2] - dtVn8[y - 2][x] - dtVn8[y + 2][x] + 7 * dtVn8[y - 1][x - 1] - dtVn8[y - 1][x + 1] - dtVn8[y + 1][x - 1] - dtVn8[y + 1][x + 1]) + C1 * (2 * dtVn8[y - 1][x - 1] - dtVn1[y / 2][x / 2] - dtVn2[y / 2][x / 2]))) / (8 * C8 + 2 * C1 + Cj);
                    q6 = (C8*(-dtQ8[y][x] + Cj * dtVn8[y - 1][x + 1] + C8 * (-dtVn8[y][x - 2] - dtVn8[y][x + 2] - dtVn8[y - 2][x] - dtVn8[y + 2][x] - dtVn8[y - 1][x - 1] + 7 * dtVn8[y - 1][x + 1] - dtVn8[y + 1][x - 1] - dtVn8[y + 1][x + 1]) + C1 * (2 * dtVn8[y - 1][x + 1] - dtVn1[y / 2][x / 2] - dtVn2[y / 2][x / 2]))) / (8 * C8 + 2 * C1 + Cj);
                    q7 = (C8*(-dtQ8[y][x] + Cj * dtVn8[y + 1][x - 1] + C8 * (-dtVn8[y][x - 2] - dtVn8[y][x + 2] - dtVn8[y - 2][x] - dtVn8[y + 2][x] - dtVn8[y - 1][x - 1] - dtVn8[y - 1][x + 1] + 7 * dtVn8[y + 1][x - 1] - dtVn8[y + 1][x + 1]) + C1 * (2 * dtVn8[y + 1][x - 1] - dtVn1[y / 2][x / 2] - dtVn2[y / 2][x / 2]))) / (8 * C8 + 2 * C1 + Cj);
                    q8 = (C8*(-dtQ8[y][x] + Cj * dtVn8[y + 1][x + 1] + C8 * (-dtVn8[y][x - 2] - dtVn8[y][x + 2] - dtVn8[y - 2][x] - dtVn8[y + 2][x] - dtVn8[y - 1][x - 1] - dtVn8[y - 1][x + 1] - dtVn8[y + 1][x - 1] + 7 * dtVn8[y + 1][x + 1]) + C1 * (2 * dtVn8[y + 1][x + 1] - dtVn1[y / 2][x / 2] - dtVn2[y / 2][x / 2]))) / (8 * C8 + 2 * C1 + Cj);
                    q9 = (C1*(-dtQ8[y][x] + Cj * dtVn1[y / 2][x / 2] + C8 * (-dtVn8[y][x - 2] - dtVn8[y][x + 2] - dtVn8[y - 2][x] - dtVn8[y + 2][x] - dtVn8[y - 1][x - 1] - dtVn8[y - 1][x + 1] - dtVn8[y + 1][x - 1] - dtVn8[y + 1][x + 1] + 8 * dtVn1[y / 2][x / 2]) + C1 * (dtVn1[y / 2][x / 2] - dtVn2[y / 2][x / 2]))) / (8 * C8 + 2 * C1 + Cj);
                    q10 = (C1*(-dtQ8[y][x] + Cj * dtVn2[y / 2][x / 2] + C8 * (-dtVn8[y][x - 2] - dtVn8[y][x + 2] - dtVn8[y - 2][x] - dtVn8[y + 2][x] - dtVn8[y - 1][x - 1] - dtVn8[y - 1][x + 1] - dtVn8[y + 1][x - 1] - dtVn8[y + 1][x + 1] + 8 * dtVn2[y / 2][x / 2]) + C1 * (dtVn2[y / 2][x / 2] - dtVn1[y / 2][x / 2]))) / (8 * C8 + 2 * C1 + Cj);
                }
                else{
                ...
                /* 8結合層のVnの更新 */
                dtVn8[y][x] = (q1 + q2 + q3 + q4 + q5 + q6 + q7 + q8 + q9 + q10 + dtQ8[y][x]) / Cj;
            }
        }

        for (y = 1; y < HOW_MANY_SINDOU_tate4 - 1; y++) {
            for (x = 1; x < HOW_MANY_SINDOU_yoko4 - 1; x++) {
                q1 = (C4*(-dtQ4[y][x] + Cj * dtVn4[y][x - 1] + C4 * (3 * dtVn4[y][x - 1] - dtVn4[y][x + 1] - dtVn4[y - 1][x] - dtVn4[y + 1][x]) + C2 * (dtVn4[y][x - 1] - dtVn1[y][x] - dtVn2[y][x]))) / (4 * C4 + 2 * C2 + Cj);
                q2 = (C4*(-dtQ4[y][x] + Cj * dtVn4[y][x + 1] + C4 * (-dtVn4[y][x - 1] + 3 * dtVn4[y][x + 1] - dtVn4[y - 1][x] - dtVn4[y + 1][x]) + C2 * (dtVn4[y][x + 1] - dtVn1[y][x] - dtVn2[y][x]))) / (4 * C4 + 2 * C2 + Cj);
                q3 = (C4*(-dtQ4[y][x] + Cj * dtVn4[y - 1][x] + C4 * (-dtVn4[y][x - 1] - dtVn4[y][x + 1] + 3 * dtVn4[y - 1][x] - dtVn4[y + 1][x]) + C2 * (dtVn4[y - 1][x] - dtVn1[y][x] - dtVn2[y][x]))) / (4 * C4 + 2 * C2 + Cj);
                q4 = (C4*(-dtQ4[y][x] + Cj * dtVn4[y + 1][x] + C4 * (-dtVn4[y][x - 1] - dtVn4[y][x + 1] - dtVn4[y - 1][x] + 3 * dtVn4[y + 1][x]) + C2 * (dtVn4[y + 1][x] - dtVn1[y][x] - dtVn2[y][x]))) / (4 * C4 + 2 * C2 + Cj);
                q5 = (C2*(-dtQ4[y][x] + Cj * dtVn1[y][x] + C4 * (-dtVn4[y][x - 1] - dtVn4[y][x + 1] - dtVn4[y - 1][x] - dtVn4[y + 1][x] + 4 * dtVn1[y][x]) + C2 * (dtVn1[y][x] - dtVn2[y][x]))) / (4 * C4 + 2 * C2 + Cj);
                q6 = (C2*(-dtQ4[y][x] + Cj * dtVn2[y][x] + C4 * (-dtVn4[y][x - 1] - dtVn4[y][x + 1] - dtVn4[y - 1][x] - dtVn4[y + 1][x] + 4 * dtVn2[y][x]) + C2 * (dtVn2[y][x] - dtVn1[y][x]))) / (4 * C4 + 2 * C2 + Cj);
                ...
                q9 = (C1*(-dtQ2[y][x] + Cj * dtVn8[2 * y][2 * x] + C2 * (dtVn8[2 * y][2 * x] - dtVn4[y][x]))) / (C1 + C2 + Cj);
                q10 = (C2*(-dtQ2[y][x] + Cj * dtVn4[y][x] + C1 * (-dtVn8[2 * y][2 * x] + dtVn4[y][x]))) / (C1 + C2 + Cj);
                /* 4結合層のVnの更新 */
                dtVn4[y][x] = (q1 + q2 + q3 + q4 + q5 + q6 + dtQ4[y][x]) / Cj;
                dtVn1[y][x] = (q7 + q8 + dtQ1[y][x]) / Cj;
                dtVn2[y][x] = (q9 + q10 + dtQ2[y][x]) / Cj;
            }
        }
        ...
        if (t > Trecord) {
            for (x = 0; x < HOW_MANY_SINDOU_yoko4 - 1; x++) {
                for (y = 0; y < HOW_MANY_SINDOU_tate4; y++) {
                    if ((x + y) % 2 == 0) {
                        if (y == 0) {
                            printf("%d %d %f\n", x, y, -dtVn4[y + 1][x + 1]);
                        }
                        else if (y == HOW_MANY_SINDOU_tate4 - 1) {
                            printf("%d %d %f\n", x, y, dtVn4[y][x + 1]);
                        }
                        else {
                            printf("%d %d %f\n", x, y, dtVn4[y][x + 1]);
        ...
        for (y = 2; y < HOW_MANY_SINDOU_tate8 - 2; y++) {
            for (x = 2; x < HOW_MANY_SINDOU_yoko8 - 2; x++) {
                if (y % 2 == 0 && x % 2 == 0){
                    if (dtVd8[y][x] > 0) {
                        dtdE8[y][x] = e * (-e + 2 * (dtQ8[y][x] + C8 * (dtVn8[y][x - 2] + dtVn8[y][x + 2] + dtVn8[y - 2][x] + dtVn8[y + 2][x] + dtVn8[y - 1][x - 1] + dtVn8[y - 1][x + 1] + dtVn8[y + 1][x - 1] + dtVn8[y + 1][x + 1]) + C1 * (dtVn1[y / 2][x / 2] + dtVn2[y / 2][x / 2]))) / (2 * (8 * C8 + 2 * C1 + Cj));
                    }
                    else {
                        dtdE8[y][x] = -e * (e + 2 * (dtQ8[y][x] + C8 * (dtVn8[y][x - 2] + dtVn8[y][x + 2] + dtVn8[y - 2][x] + dtVn8[y + 2][x] + dtVn8[y - 1][x - 1] + dtVn8[y - 1][x + 1] + dtVn8[y + 1][x - 1] + dtVn8[y + 1][x + 1]) + C1 * (dtVn1[y / 2][x / 2] + dtVn2[y / 2][x / 2]))) / (2 * (8 * C8 + 2 * C1 + Cj));
                    }
        ...
        for (y = 1; y < HOW_MANY_SINDOU_tate4 - 1; y++) {
            for (x = 1; x < HOW_MANY_SINDOU_yoko4 - 1; x++) {
                if (dtVd4[y][x] > 0) {
                        dtdE4[y][x] = e * (-e + 2 * (dtQ4[y][x] + C4 * (dtVn4[y][x - 1] + dtVn4[y][x + 1] + dtVn4[y - 1][x] + dtVn4[y + 1][x]) + C2 * (dtVn1[y][x] + dtVn2[y][x]))) / (2 * (4 * C4 + 2 * C2 + Cj));
                }
                else {
                        dtdE4[y][x] = -e * (e + 2 * (dtQ4[y][x] + C4 * (dtVn4[y][x - 1] + dtVn4[y][x + 1] + dtVn4[y - 1][x] + dtVn4[y + 1][x]) + C2 * (dtVn1[y][x] + dtVn2[y][x]))) / (2 * (4 * C4 + 2 * C2 + Cj));        
                }
                ...
                if (dtVd2[y][x] > 0) {
                        dtdE2[y][x] = e * (-e + 2 * (dtQ2[y][x] + C1 * dtVn8[2 * y][2 * x] + C2 * dtVn4[y][x])) / (2 * (C1 + C2 + Cj));
                }
                else {
                        dtdE2[y][x] = -e * (e + 2 * (dtQ2[y][x] + C1 * dtVn8[2 * y][2 * x] + C2 * dtVn4[y][x])) / (2 * (C1 + C2 + Cj));
                }
