	...
	while(t <= START_OF_TRIGER + 500){
        ...
        for(b = 1; b < NUMBER_OF_SINDOUSI_TATE; b++){
            for(a = 1; a < NUMBER_OF_SINDOUSI_YOKO; a++){
                ...
                V81[b][a] = Vnn[2*b][2*a];
                V41[b][a] = Vn4[b][a];
                if((b == 30 && a == 21) || (b == 25 && a == 21) || (b == 30 && a == 29) || (b == 25 && a == 29)){
                    Vst[b][a] = Vns[0];
        ...
        for(b = 2; b < N_TATE-1; b++){
            for(a = 2; a < N_YOKO-1; a++){
                ...
                if((b == 50 && a == 42) || (b == 51 && a == 41) || (b == 51 && a == 43) || (b == 49 && a == 43) || (b == 50 && a == 58) || (b == 51 && a == 57) || (b == 51 && a == 59) || (b == 49 && a == 57)){
                    Vsn[b][a] = Vns[0];
        ...
        for(b = 1; b < NUMBER_OF_SINDOUSI_TATE; b++){
            for(a = 1; a < NUMBER_OF_SINDOUSI_YOKO; a++){
                if((b == 30 && a == 21) || (b == 25 && a == 21) || (b == 30 && a == 29) || (b == 25 && a == 29) || (b == 28 && a == 21) || (b == 28 && a == 29)){
        ...
        for(b = 2; b < N_TATE-1; b++){
            for(a = 2; a < N_YOKO-1; a++){
                if(b % 2 == 0 && a % 2 == 0){
                    if((b == 50 && a == 42) || (b == 51 && a == 41) || (b == 51 && a == 43) || (b == 49 && a == 43) || (b == 50 && a == 58) || (b == 51 && a == 57) || (b == 51 && a == 59) || (b == 49 && a == 57) || (b == 42 && a == 50) || (b == 43 && a == 49) || (b == 43 && a == 51) || (b == 41 && a == 49) || (b == 41 && a == 51) || (b == 40 && a == 50)){
        ...
        qs[1] = (-NUMBER_OF_JUNCTION*(-Cj*Qs[1]-Cs*Cj*(V13+V15+V16+V17+V18+V19))-Cj*Ls[1]*e)/(NUMBER_OF_JUNCTION*(6*Cs)+Cj);
        qs[2] = (-NUMBER_OF_JUNCTION*(-Cj*Qs[2]-Cs*Cj*(V20+V21+V22+V23))-Cj*Ls[2]*e)/(NUMBER_OF_JUNCTION*(4*Cs)+Cj);
        ...
        //Vnの出力
        printf("%f %f %f %f %f %f %f %f %f %f %f %f %f %f\n",t, Vns[0], Vns[1], Vns[2], Vnn[42][50], Vnn[41][51], Vnn[41][49], Vnn[42][52], Vnn[42][48], Vnn[40][50], Vnn[50][42], Vnn[50][58], Vnn[51][57], Vnn[49][59]);
        ...
        for(b = 0; b < 3; b++) {
            if (b == 0){
                ...
                dEups[b] = e*((-(NUMBER_OF_JUNCTION-1)*4+2*4*Ls[b])*Cs*e+Cj*(2*Qs[b]-e)+2*Cs*Cj*(V20+V21+V22+V23))/(2*Cj*(4*NUMBER_OF_JUNCTION*Cs+Cj));
                dEdowns[b] = -e*(-(-(NUMBER_OF_JUNCTION-1)*4-2*4*Ls[b])*Cs*e+Cj*(2*Qs[b]+e)+2*Cs*Cj*(V20+V21+V22+V23))/(2*Cj*(4*NUMBER_OF_JUNCTION*Cs+Cj));
            }
            if(dEups[b] > 0){
