	...
	while(t <= START_OF_TRIGER + 500){
        ...
        for(b = 1; b < NUMBER_OF_SINDOUSI_TATE-1; b++){
            for(a = 1; a < NUMBER_OF_SINDOUSI_YOKO-1; a++){
                ...
                V81[b][a] = Vnn[2*b][2*a];
                V41[b][a] = Vn4[b][a];
                if((b == 20 && a == 21) || (b == 25 && a == 21)){
                    Vst[b][a] = Vns[0];
                }else if ((b == 20 && a == 29) || (b == 25 && a == 29)){
                    Vst[b][a] = Vns[1];
                }else{
                    Vst[b][a] = 0;
                }
        ...
        for(b = 2; b < N_TATE-1; b++){
            for(a = 2; a < N_YOKO-1; a++){
                ...
                if((b == 50 && a == 42) || (b == 49 && a == 43) || (b == 49 && a == 41) || (b == 51 && a == 41)){
                    Vsn[b][a] = Vns[0];
                }else if((b == 50 && a == 58) || (b == 49 && a == 59) || (b == 49 && a == 57) || (b == 51 && a == 57)){
                    Vsn[b][a] = Vns[1];
                }else{
                    Vsn[b][a] = 0;
                }
        ...
        for(b = 1; b < NUMBER_OF_SINDOUSI_TATE-1; b++){
            for(a = 1; a < NUMBER_OF_SINDOUSI_YOKO-1; a++){
                if((b == 20 && a == 21) || (b == 25 && a == 21) || (b == 20 && a == 29) || (b == 25 && a == 29)){
        ...
        for(b = 2; b < N_TATE-1; b++){
            for(a = 2; a < N_YOKO-1; a++){
                if(b % 2 == 0 && a % 2 == 0){
                    if((b == 50 && a == 42) || (b == 49 && a == 43) || (b == 49 && a == 41) || (b == 51 && a == 41) || (b == 50 && a == 58) || (b == 49 && a == 59) || (b == 49 && a == 57) || (b == 51 && a == 57)){
