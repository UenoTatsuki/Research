...
#define Trigger_Timing_2 1507.0 /*2層目にトリガを加えるタイミング*/
...
int main() {
    ...
    double Cx = 0.7;//[aF]
    double Cs = 2.0;//[aF]
    double Vd1 = 0.00468;//[V]
    double Vd2 = 0.00290;//[V]
    double Vin = 0.01;//[V]
    double Vin2 = 0.012;//[V]
    ...
    while (t <= T_END) {
        ...
        for (y = 1; y < HOW_MANY_SINDOU_tate - 1; y++) {
            for (x = 1; x < HOW_MANY_SINDOU_yoko - 1; x++) {
                ...
                q1 = (C8*(-dtQ1[y][x] + Cj * dtVn1[y][x - 1] + C8 * (3 * dtVn1[y][x - 1] - dtVn1[y][x + 1] - dtVn1[y - 1][x] - dtVn1[y + 1][x]) + Cx * (4 * dtVn1[y][x - 1] - dtVn1[y - 1][x - 1] - dtVn1[y - 1][x + 1] - dtVn1[y + 1][x - 1] - dtVn1[y + 1][x + 1]) + Cs * (dtVn1[y][x - 1] - dtVn2[y][x]))) / (4 * C8 + 4 * Cx + Cs + Cj);
                q2 = (C8*(-dtQ1[y][x] + Cj * dtVn1[y][x + 1] + C8 * (-dtVn1[y][x - 1] + 3 * dtVn1[y][x + 1] - dtVn1[y - 1][x] - dtVn1[y + 1][x]) + Cx * (4 * dtVn1[y][x + 1] - dtVn1[y - 1][x - 1] - dtVn1[y - 1][x + 1] - dtVn1[y + 1][x - 1] - dtVn1[y + 1][x + 1]) + Cs * (dtVn1[y][x + 1] - dtVn2[y][x]))) / (4 * C8 + 4 * Cx + Cs + Cj);
                q3 = (C8*(-dtQ1[y][x] + Cj * dtVn1[y - 1][x] + C8 * (-dtVn1[y][x - 1] - dtVn1[y][x + 1] + 3 * dtVn1[y - 1][x] - dtVn1[y + 1][x]) + Cx * (4 * dtVn1[y - 1][x] - dtVn1[y - 1][x - 1] - dtVn1[y - 1][x + 1] - dtVn1[y + 1][x - 1] - dtVn1[y + 1][x + 1]) + Cs * (dtVn1[y - 1][x] - dtVn2[y][x]))) / (4 * C8 + 4 * Cx + Cs + Cj);
                q4 = (C8*(-dtQ1[y][x] + Cj * dtVn1[y + 1][x] + C8 * (-dtVn1[y][x - 1] - dtVn1[y][x + 1] - dtVn1[y - 1][x] + 3 * dtVn1[y + 1][x]) + Cx * (4 * dtVn1[y + 1][x] - dtVn1[y - 1][x - 1] - dtVn1[y - 1][x + 1] - dtVn1[y + 1][x - 1] - dtVn1[y + 1][x + 1]) + Cs * (dtVn1[y + 1][x] - dtVn2[y][x]))) / (4 * C8 + 4 * Cx + Cs + Cj);
                q5 = (Cx*(-dtQ1[y][x] + Cj * dtVn1[y - 1][x - 1] + C8 * (-dtVn1[y][x - 1] - dtVn1[y][x + 1] - dtVn1[y - 1][x] - dtVn1[y + 1][x] + 4 * dtVn1[y - 1][x - 1]) + Cx * (3 * dtVn1[y - 1][x - 1] - dtVn1[y - 1][x + 1] - dtVn1[y + 1][x - 1] - dtVn1[y + 1][x + 1]) + Cs * (dtVn1[y - 1][x - 1] - dtVn2[y][x]))) / (4 * C8 + 4 * Cx + Cs + Cj);
                q6 = (Cx*(-dtQ1[y][x] + Cj * dtVn1[y - 1][x + 1] + C8 * (-dtVn1[y][x - 1] - dtVn1[y][x + 1] - dtVn1[y - 1][x] - dtVn1[y + 1][x] + 4 * dtVn1[y - 1][x + 1]) + Cx * (-dtVn1[y - 1][x - 1] + 3 * dtVn1[y - 1][x + 1] - dtVn1[y + 1][x - 1] - dtVn1[y + 1][x + 1]) + Cs * (dtVn1[y - 1][x + 1] - dtVn2[y][x]))) / (4 * C8 + 4 * Cx + Cs + Cj);
                q7 = (Cx*(-dtQ1[y][x] + Cj * dtVn1[y + 1][x - 1] + C8 * (-dtVn1[y][x - 1] - dtVn1[y][x + 1] - dtVn1[y - 1][x] - dtVn1[y + 1][x] + 4 * dtVn1[y + 1][x - 1]) + Cx * (-dtVn1[y - 1][x - 1] - dtVn1[y - 1][x + 1] + 3 * dtVn1[y + 1][x - 1] - dtVn1[y + 1][x + 1]) + Cs * (dtVn1[y + 1][x - 1] - dtVn2[y][x]))) / (4 * C8 + 4 * Cx + Cs + Cj);
                q8 = (Cx*(-dtQ1[y][x] + Cj * dtVn1[y + 1][x + 1] + C8 * (-dtVn1[y][x - 1] - dtVn1[y][x + 1] - dtVn1[y - 1][x] - dtVn1[y + 1][x] + 4 * dtVn1[y + 1][x + 1]) + Cx * (-dtVn1[y - 1][x - 1] - dtVn1[y - 1][x + 1] - dtVn1[y + 1][x - 1] + 3 * dtVn1[y + 1][x + 1]) + Cs * (dtVn1[y + 1][x + 1] - dtVn2[y][x]))) / (4 * C8 + 4 * Cx + Cs + Cj);
                q9 = (Cs*(-dtQ1[y][x] + Cj * dtVn2[y][x] + C8 * (-dtVn1[y][x - 1] - dtVn1[y][x + 1] - dtVn1[y - 1][x] - dtVn1[y + 1][x] + 4 * dtVn2[y][x]) + Cx * (-dtVn1[y - 1][x - 1] - dtVn1[y - 1][x + 1] - dtVn1[y + 1][x - 1] - dtVn1[y + 1][x + 1] + 4 * dtVn2[y][x]))) / (4 * C8 + 4 * Cx + Cs + Cj);
                /* Vnの更新 */
        ...
        /* Vnの出力 */
        printf("%f %f %f %f %f %f\n",t, dtVn1[1][9], dtVn1[1][10], dtVn1[1][11], dtVn1[1][12], dtVn1[1][13], dtVn2[1][9], dtVn2[1][10], dtVn2[1][11], dtVn2[1][12], dtVn2[1][13], dtVn2[2][9], dtVn2[2][10], dtVn2[2][11], dtVn2[2][12], dtVn[2][13]);

        /* dEの計算 */
        for (y = 1; y < HOW_MANY_SINDOU_tate - 1; y++) {
            for (x = 1; x < HOW_MANY_SINDOU_yoko - 1; x++) {
                if (dtVd1[y][x] > 0) {
                        dtdE1[y][x] = e * (-e + 2 * (dtQ1[y][x] + C8 * (dtVn1[y][x - 1] + dtVn1[y][x + 1] + dtVn1[y - 1][x] + dtVn1[y + 1][x]) + Cx * (dtVn1[y - 1][x - 1] + dtVn1[y - 1][x + 1] + dtVn1[y + 1][x - 1] + dtVn1[y + 1][x + 1]) + Cs * dtVn2[y][x])) / (2 * (4 * C8 + 4 * Cx + Cs + Cj));
                }
                else {
                        dtdE1[y][x] = -e * (e + 2 * (dtQ1[y][x] + C8 * (dtVn1[y][x - 1] + dtVn1[y][x + 1] + dtVn1[y - 1][x] + dtVn1[y + 1][x]) + Cx * (dtVn1[y - 1][x - 1] + dtVn1[y - 1][x + 1] + dtVn1[y + 1][x - 1] + dtVn1[y + 1][x + 1]) + Cs * dtVn2[y][x])) / (2 * (4 * C8 + 4 * Cx + Cs + Cj));
                }
