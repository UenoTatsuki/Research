...
int main() {
    ...
    while (t <= T_END) {
        ...
        //Vnの出力
        printf("%f %f %f %f %f %f %f %f %f %f %f %f %f %f\n",t, dtVn4[6][4], dtVn4[6][3], dtVn4[5][4], dtVn1[6][4], dtVn1[6][3], dtVn4[1][4], dtVn4[2][5], dtVn1[2][2], dtVn2[2][2], dtVn1[3][3], dtVn2[3][3], dtVn8[2][2], dtVn8[2][3]);
