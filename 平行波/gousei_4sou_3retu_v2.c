...
#define END_OF_TRIGER 3550
#define START_OF_TRIGER4 3550
#define END_OF_TRIGER4 3555
#define NUM_PULSE 1
	...
	while(t <= START_OF_TRIGER + 500){
        ...
        for(b = 1; b < NUMBER_OF_SINDOUSI_TATE-1; b++){
            for(a = 1; a < NUMBER_OF_SINDOUSI_YOKO-1; a++){
                ...
                V81[b][a] = Vnn[2*b][2*a];
                V41[b][a] = Vn4[b][a];
                if((b == 13 && a == 6) || (b == 13 && a == 11) || (b == 11 && a == 13) || (b == 6 && a == 13)){
                    Vst[b][a] = Vns[0];
                }else if ((b == 10 && a == 9) || (b == 9 && a == 10) || (b == 5 && a == 9) || (b == 9 && a == 5)){
                    Vst[b][a] = Vns[1];
                }else{
                    Vst[b][a] = 0;
                }
        ...
        for(b = 1; b < NUMBER_OF_SINDOUSI_TATE-1; b++){
            for(a = 1; a < NUMBER_OF_SINDOUSI_YOKO-1; a++){
                if((b == 13 && a == 8) || (b == 13 && a == 11) || (b == 11 && a == 13) || (b == 8 && a == 13) || (b == 10 && a == 9) || (b == 9 && a == 10) || (b == 5 && a == 9) || (b == 9 && a == 5)){
        ...
        for(b = 0; b < 2; b++) {
            if (b == 0){
                ...
                dEdowns[b] = -e*(-(-(NUMBER_OF_JUNCTION-1)*4-2*4*Ls[b])*Cs*e+Cj*(2*Qs[b]+e)+2*Cs*Cj*(V13+V17+V15+V16))/(2*Cj*(12*NUMBER_OF_JUNCTION*Cs+Cj));
            }
            if(dEups[b] > 0){
