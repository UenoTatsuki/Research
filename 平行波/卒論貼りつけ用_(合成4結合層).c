...
#define N_TATE 100
#define N_YOKO 100
#define START_OF_TRIGER 2000
#define END_OF_TRIGER 2005
#define START_OF_TRIGER4 2050
#define END_OF_TRIGER4 2055
#define NUM_PULSE 1
	...
	while(t <= START_OF_TRIGER + 500){
        ...
        for(b = 1; b < NUMBER_OF_SINDOUSI_TATE-1; b++){
            for(a = 1; a < NUMBER_OF_SINDOUSI_YOKO-1; a++){
                ...
                V81[b][a] = Vnn[2*b][2*a];
                V41[b][a] = Vn4[b][a];
                if((b == 29 && a == 25) || (b == 25 && a == 29) || (b == 20 && a == 29) || (b == 29 && a == 20)){
                    Vst[b][a] = Vns;
                }else{
                    Vst[b][a] = 0;
                }
        ...
        for(b = 2; b < N_TATE-1; b++){
            for(a = 2; a < N_YOKO-1; a++){
                ...
                if((b == 58 && a == 50) || (b == 50 && a == 58) || (b == 57 && a == 49) || (b == 57 && a == 51) || (b == 59 && a == 49) || (b == 49 && a == 57) || (b == 49 && a == 59) || (b == 51 && a == 57)){
                    Vsn[b][a] = Vns;
                }else{
                    Vsn[b][a] = 0;
                }
        ...
        qs = (-NUMBER_OF_JUNCTION*(-Cj*Qs-Cs*Cj*(V1+V2+V3+V4+V5+V6+V7+V8+V9+V10+V11+V12))-Cj*Ls*e)/(NUMBER_OF_JUNCTION*(12*Cs)+Cj);
        ...
        dEups = e*((-(NUMBER_OF_JUNCTION-1)*12+2*12*Ls)*Cs*e+Cj*(2*Qs-e)+2*Cs*Cj*(V1+V2+V3+V4+V5+V6+V7+V8+V9+V10+V11+V12))/(2*Cj*(12*NUMBER_OF_JUNCTION*Cs+Cj));
        dEdowns = -e*(-(-(NUMBER_OF_JUNCTION-1)*12-2*12*Ls)*Cs*e+Cj*(2*Qs+e)+2*Cs*Cj*(V1+V2+V3+V4+V5+V6+V7+V8+V9+V10+V11+V12))/(2*Cj*(12*NUMBER_OF_JUNCTION*Cs+Cj));

        if(dEups > 0){
            for(i = 0; i < NUMBER_OF_JUNCTION-Ls; i++){
                r = (double)rand()/RAND_MAX;
                wt = (e*e*Rj/dEups)*log(1/r);
