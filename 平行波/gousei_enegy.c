	...
	while(t <= START_OF_TRIGER + 500){
        ...
        for(b = 1; b < NUMBER_OF_SINDOUSI_TATE-1; b++){
            for(a = 1; a < NUMBER_OF_SINDOUSI_YOKO-1; a++){
                ...
                V81[b][a] = Vnn[2*b][2*a];
                V41[b][a] = Vn4[b][a];
                if((b == 29 && a == 25) || (b == 25 && a == 29) || (b == 18 && a == 29) || (b == 29 && a == 18)){
                    Vst[b][a] = Vns[0];
                }else if ((b == 21 && a == 22) || (b == 22 && a == 21) || (b == 15 && a == 21) || (b == 21 && a == 15)){
                    Vst[b][a] = Vns[1];
                }else{
                    Vst[b][a] = 0;
                }
        ...
        for(b = 1; b < NUMBER_OF_SINDOUSI_TATE-1; b++){
            for(a = 1; a < NUMBER_OF_SINDOUSI_YOKO-1; a++){
                if((b == 29 && a == 25) || (b == 25 && a == 29) || (b == 18 && a == 29) || (b == 29 && a == 18) || (b == 21 && a == 22) || (b == 22 && a == 21) || (b == 15 && a == 21) || (b == 21 && a == 15)){
